    ...
    public function generate_image($article_title, $category_name) {
        ...
        $args = array(
            ...
            'body' => json_encode(array(
                ...
                'prompt' => $image_prompt,
                'n' => 1,
                'size' => '1792x1024', // Panoramiczny format dla Google Discover (min 1200px)
                'quality' => 'hd' // HD quality dla lepszej jakości w Discover
            )),
            'timeout' => 120
        );
    ...
    private function build_article_user_prompt($news_data, $category_name, $province, $keywords, $language = 'pl') {
        $templates = array(
            ...
            'de' => array(
                ...
                'req7' => "7. STORYTELLING UND GOOGLE DISCOVER:\n   - Beginne mit konkretem Beispiel, Situation oder Ereignis\n   - Zeige Auswirkungen auf das Leben der Bürger (humanisiere den Inhalt)\n   - Füge Mikrogeschichten oder Fallstudien hinzu\n   - Verwende EMOTIONEN: Freude, Hoffnung, Überraschung, Sorge\n   - Beschreibe MENSCHEN: Bürger, lokale Helden, gewöhnliche Menschen\n   - Schließe mit Zukunftsvision oder Schlussfolgerungen\n   - TITEL muss ansprechend und wertvoll sein (für Google Discover)\n   - LEAD (erste 2-3 Sätze) muss sofort Aufmerksamkeit erregen\n\n",
            ...
            'en' => array(
                ...
                'req7' => "7. STORYTELLING AND GOOGLE DISCOVER:\n   - Start with a concrete example, situation, or event\n   - Show impact on residents' lives (humanize content)\n   - Add micro-stories or case studies\n   - Use EMOTIONS: joy, hope, surprise, concern\n   - Describe PEOPLE: residents, local heroes, ordinary people\n   - End with a vision of the future or conclusions\n   - TITLE must be engaging and valuable (for Google Discover)\n   - LEAD (first 2-3 sentences) must immediately capture attention\n\n",
            ...
            'uk' => array(
                ...
                'req7' => "7. СТОРІТЕЛІНГ ТА GOOGLE DISCOVER:\n   - Почни з конкретного прикладу, ситуації або події\n   - Покажи вплив на життя мешканців (гуманізуй контент)\n   - Додай мікроісторії або кейс-стаді\n   - Використовуй ЕМОЦІЇ: радість, надія, здивування, турбота\n   - Описуй ЛЮДЕЙ: мешканців, місцевих героїв, звичайних людей\n   - Завершуй баченням майбутнього або висновками\n   - ЗАГОЛОВОК повинен бути захоплюючим та цінним (для Google Discover)\n   - ЛІД (перші 2-3 речення) повинен одразу привертати увагу\n\n",
